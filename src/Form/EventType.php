...
class EventType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('whatsapp_number', TextType::class, [
                    'label' => 'Whatsapp Name',
                    'required' => false,
                    'attr' => [
                        'class' => 'form-control',
                        'style' => 'display: none;' // Hide the field by default
                    ]
                ])
                ...
                ->add('chatbot_list', ChoiceType::class, [
                    'required' => false,
                    'label' => 'Chatbot list',
                    'help' => "Select the chatbot that you send to attendee",
                    'choices' => $this->services->getChatbotsAsChoices(),
                    'attr' => ['class' => 'select2', 'data-sort-options' => '1']
                ])

                
                ->add('tickettemplate', ChoiceType::class, [
                    'required' => false,
                    'choices' => [
                        'Template 1' => 1,
                        'Template 2' => 2,
                    ...
                    'data' => 1, // Set the default value to 1 (Template 1)
                ])
                ...
                ->add('imageFile', VichImageType::class, [
                    ...
                    'attr' => ['accept' => 'image/jpeg,image/png,image/jpg,image/webp'],
                ])

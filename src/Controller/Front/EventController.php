...
// dd($events[0]);
     ...
     */
    public function event($slug, AppServices $services, TranslatorInterface $translator, Connection $connection) {
        ...
        $sql = "SELECT * FROM  chatbot_lists WHERE id = :id";
        $params = ['id' => $event->getChatbotList()];
        ...
        return $this->render('Front/Event/event.html.twig', [
            "event" => $event,
            'chatbot_id' => isset($chatbot['chatbot_id']) ? $chatbot['chatbot_id'] : null,

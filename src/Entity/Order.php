...
// -2: failed / -1: cancel / 0: waiting for payment / 1: paid
    ...
    public function getTicketSendStatus() {
        return $this->ticket_send_status;
    }

    public function setTicketSendStatus($ticket_send_status) {
        $this->ticket_send_status = $ticket_send_status;
...
// set the owning side to null (unless already changed)
    ...
    public function setJoinMeeting($joinMeeting)
    {
